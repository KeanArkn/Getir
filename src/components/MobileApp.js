...
function MobileApp() {
  return (
    <div className="bg-primary-brand-color flex flex-col md:flex-row justify-between items-center md:rounded-lg text-white ">
      <div className="flex flex-col gap-y-3 p-10 text-center">
      ...
      <div className="pt-6 hidden md:block lg:self-end">
